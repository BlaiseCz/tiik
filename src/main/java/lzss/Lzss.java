...
public class Lzss {
    public static void main(String[] args) throws Exception{
        String src = "lalalsdahfjkshdfjksdhfjksdhfjksdhfjkshdfkjhsdjkfhjksdhfjkdshfjkhsdjkfhksdjhfkjdshfjkh";
        src = read("/Users/krzysztofczarnecki/Documents/GitHub/tiik/xd.txt");
        int windowSize = 8192;
...
//        dump(ret);
        ...
        ///
        FileOutputStream fout = new FileOutputStream("dumb.ser");
